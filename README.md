...
| ![全站悬浮提醒](docs/screenshots/screenshot-toast.png) | **全站悬浮提醒**：位置自选、倒计时 + 进度条、关闭方式菜单（本次 / 3 天 / 10 天 / 永久） |
...
构建结果位于 `build/libs/plugin-important-dates-<版本>.jar`（当前开发版为 `1.2.0-SNAPSHOT`，正式版为 `1.2.0`）。

> 版本说明：**开发版** `1.2.0-SNAPSHOT`（座驾模块，开发中）；**正式版** 1.1.0 → 1.1.5 → **1.2.0**（更名「记得」）。
