...
| ![全站悬浮提醒](https://raw.githubusercontent.com/yyliucha/plugin-important-dates/main/docs/screenshots/screenshot-toast.png) | **悬浮提醒**：位置自选、倒计时 + 进度条、关闭方式菜单（本次 / 3 天 / 10 天 / 永久），默认只在「记得」页弹出 |
